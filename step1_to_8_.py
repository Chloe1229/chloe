...
STEP7_ROWS = [
    ...
    },
    {
        "title_key": "p3_12",
        "title_text": "3.2.P.3 제조\n12. 완제의약품 제조공정의 일부 또는 전부에 대한 제조소 추가 또는 변경",
        "output_condition_all_met": "(\n    step6_selections.get(\"p3_12_sub_12b\") == \"변경 있음\" and step6_selections.get(\"p3_12_req_2\") == \"충족\" and step6_selections.get(\"p3_12_req_3\") == \"충족\" and step6_selections.get(\"p3_12_req_4\") == \"충족\" and step6_selections.get(\"p3_12_req_1\") == \"미충족\" and step6_selections.get(\"p3_12_req_5\") == \"미충족\"\n)",
        "output_1_tag": "Cmin",
        "output_1_text": "보고유형은 다음과 같습니다.\n\nCmin, 변경허가(신고)\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Minor change(Cmin)수준의 변경사항입니다.",
...
if st.session_state.step == 7:
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.button("이전단계로", on_click=go_prev_step7_page, disabled=st.session_state.step7_page == 0)
    with col2:
        if st.session_state.step7_page == len(st.session_state.step6_targets) - 1:
